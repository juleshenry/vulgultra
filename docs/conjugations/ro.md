...
Template stem args observed: `abandon`, `abdic`, `aber`, `abilit`, `ablact` (+719 more).
...
Template stem args observed: `absolv`, `absorb/absoarb`, `abur`, `acoper`, `acr` (+434 more).
...
Template stem args observed: `voi`.
