...
Template stem args observed: `<hue>`, `<ie>`, `<only3s>`, `<only3sp>`, `<ue.only3s>` (+2 more).
...
| `indicative.preterite` | 1 | `lcp` | -e | -iste | -o | -imos | -isteis | -ieron |
| `nonfinite.gerund` | 1 | `lcp` | -me | -te | -se | -nos | -os | -se |
| `nonfinite.infinitive` | 1 | `lcp` | -me | -te | -se | -nos | -os | -se |
| `subjunctive.future` | 1 | `lcp` | -ere | -eres | -ere | -éremos | -ereis | -eren |
| `subjunctive.imperfect` | 1 | `lcp` | -era | -eras | -era | -éramos | -erais | -eran |
| `subjunctive.present` | 1 | `lcp` | -é | -és | -é | -emos | -éis | -én |
...
| `subjunctive.future` | 1 | `lcp` | -ere | -eres | -ere | -éremos | -ereis | -eren |
| `subjunctive.imperfect` | 1 | `lcp` | -era | -eras | -era | -éramos | -erais | -eran |
| `subjunctive.present` | 1 | `lcp` | -a | -as | -a | -amos | -áis | -an |
...
| `conditional` | 1 | `lcp` | ∅ | -s | ∅ | -mos | -is | -n |
| `indicative.future` | 1 | `lcp` | -é | -ás | -á | -emos | -éis | -án |
| `indicative.present` | 1 | `lcp` | -oy | -as | -a | -amos | -ais | -an |
