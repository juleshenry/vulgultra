...
Template stem args observed: `acredit`, `acurd`, `acus`, `adat`, `adot` (+137 more).
...
Template stem args observed: `atribu`, `cap`, `costitu`, `cunfer`, `dorm` (+15 more).
