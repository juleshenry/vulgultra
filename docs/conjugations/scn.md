...
Template stem args observed: `'ccatt`, `'ddum`, `abbac`, `abbagn`, `abbianchi` (+67 more).
...
Template stem args observed: `addurmìsc`, `chianc`, `crid`, `cumprenn`, `cunch` (+14 more).
