...
Template stem args observed: `abacoch`, `abandon`, `abarat`, `ablandi`, `abluc` (+990 more).
...
Template stem args observed: `abat`, `abol`, `abr`, `ad`, `adorm` (+75 more).
...
Template stem args observed: `a`, `abat`, `aborre`, `adeprend`, `agrade` (+60 more).
